...
define('HEADING_TITLE', '编辑订单 #%s 日期 %s');
...
define('TABLE_HEADING_NEW_STATUS', '新状态');
...
define('TABLE_HEADING_TOTAL', '小计');
define('TABLE_HEADING_BASE_PRICE', '价格<br>(基本)');
define('TABLE_HEADING_UNIT_PRICE', '价格<br>(不含税)');
define('TABLE_HEADING_UNIT_PRICE_TAXED', '价格<br>(含税)');
define('TABLE_HEADING_TOTAL_PRICE', '小计<br>(不含税)');
define('TABLE_HEADING_TOTAL_PRICE_TAXED', '小计<br>(含税)');
define('TABLE_HEADING_OT_TOTALS', '订单总计:');
define('TABLE_HEADING_OT_VALUES', '值:');
define('TABLE_HEADING_SHIPPING_QUOTES', '配送方式:');
define('TABLE_HEADING_NO_SHIPPING_QUOTES', '无配送方式!');
...
define('ENTRY_CURRENCY_TYPE', '货币');
define('ENTRY_CURRENCY_VALUE', '币值');

define('TEXT_INFO_PAYMENT_METHOD', 'Payment Method:');
define('TEXT_NO_ORDER_PRODUCTS', 'This order contains no products');
define('TEXT_ADD_NEW_PRODUCT', '添加商品');
define('TEXT_PACKAGE_WEIGHT_COUNT', '包裹重量: %s  | 商品数量: %s');
...
define('TEXT_SHIPPING_SAME_AS_BILLING', '送货地址与账单地址相同');
define('TEXT_BILLING_SAME_AS_CUSTOMER', '账单地址同客户注册地址');

define('IMAGE_ADD_NEW_OT', '插入新的订单总计');
...
define('HINT_PRESS_UPDATE', '请单击更新保存更改');
