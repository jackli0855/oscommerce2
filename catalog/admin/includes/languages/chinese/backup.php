...
define('TEXT_INFO_RESTORE', '不要中断恢复进程.<br /><br />备份文件越大所需的时间！越长<br /><br />如果服务器允许尽量使用Mysql远程命令实现恢复.<br /><br />如:<br /><br /><strong>mysql -h' . DB_SERVER . ' -u' . DB_SERVER_USERNAME . ' -p ****** < %s </strong> %s');
