...
define('JQUERY_DATEPICKER_I18N_CODE', 'zh-CN'); // leave empty for en_US; see http://jqueryui.com/demos/datepicker/#localization
...
define('BOX_HEADING_ARTICLES', '内容管理');
...
define('BOX_CUSTOMERS_GROUP', '客户分组');
define('BOX_BUNDLE_SALE', '捆绑销售');
define('BOX_QUICK_UPDATES', '快速更新');
...
define('ENTRY_EMAIL_ADDRESS_ERROR', '&nbsp;<span class="errorText">至少 ' . ENTRY_EMAIL_ADDRESS_MIN_LENGTH . ' 字符</span>');
...
define('IMAGE_ICON_STATUS_GREEN_LIGHT', '设为激活');
define('IMAGE_ICON_STATUS_RED', '待用');
define('IMAGE_ICON_STATUS_RED_LIGHT', '设置为待用');
...
define('TEXT_DISPLAY_NUMBER_OF_NEWSLETTERS', '显示 <strong>%d</strong> 到 <strong>%d</strong> (共 <strong>%d</strong> 订阅)');
...
define('BOX_CATALOG_DISCOUNT_CODE', '折扣代码');
define('TEXT_DISPLAY_NUMBER_OF_DISCOUNT_CODES', '显示 <b>%d</b> 到 <b>%d</b> (共 <b>%d</b> 折扣码)');
...
define('TEXT_CACHE_CATEGORIES', '商品目录区');
define('TEXT_CACHE_MANUFACTURERS', '品牌区');
define('TEXT_CACHE_ALSO_PURCHASED', '推荐模块');

define('TEXT_NONE', '--无--');
define('TEXT_TOP', '顶端');
define('MODULES_ADMIN_MENU_TOOLS_DATABASE_TABLES', '数据库表');
 define('MODULES_ADMIN_MENU_TOOLS_SECURITY_CHECKS', '安全检查');
...
define('BOX_CATALOG_USE_EXCEL','导入/导出 excel');
