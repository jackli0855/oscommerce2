...
@setlocale(LC_ALL, array('zh_CN.UTF-8', 'zh_CN.UTF8', 'chs_chn'));
...
define('HEADER_TITLE_CREATE_ACCOUNT', '注册');
...
define('ENTRY_EMAIL_ADDRESS_CHECK_ERROR', '您的电子邮件地址不对 - 请做必要修改。');
...
define('TEXT_RESULT_HEAD','找到 <span>%s</span> 件商品。 在<span>%s</span>中');
...
define('TEXT_DISCOUNT_CODE','优惠券代码:');
define('TEXT_DISCOUNT', '折扣');
define('TEXT_DISCOUNT_ENTER', '如果您有折扣代码，请在这里输入.');
define('TEXT_DISCOUNT_APPLY', '兑换');
define('TEXT_SUPPORT','服务与支持');
define('TEXT_TICKETS','我的服务单');
define('CHECKOUT_AS_GUEST','访客直接结账');
define('TEXT_FEATURED','精品推荐');
define('TEXT_USEPOINT','积分');
define('TEXT_HAVEPOINT','您当前拥有消费积分 %s 点');
define('TEXT_USE','使用');
define('TEXT_GROUP_DISCOUNT','等级折扣');
define('TEXT_UPGRADEPOINT','升级积分');
define('TEXT_POINT','点');
define('TEXT_CUSTOMERGROUP','客户等级');
define('TEXT_GROUPNAME','级别');
define('TEXT_ACTION','操作');
define('TEXT_BONUS_HISTORY','消费积分记录');
define('TEXT_ACCOUNT_CREDITS','积分与等级');
define('TEXT_ADD_WISHLIST', '加入收藏');
define('TEXT_MY_WISHLIST', '我的收藏');
define('TEXT_SUCCESS_ADDED_PRODUCTS','您已成功将 %s 加入到了您的 <a href="'.tep_href_link(FILENAME_SHOPPING_CART).'">购物车</a> !');
define('TEXT_SUCCESS_ADDED_WISHLIST','商品 %s 已成功加入 <a href="'.tep_href_link(FILENAME_WISHLIST).'">我的收藏</a> !');
define('TEXT_FAILD_ADDED_WISHLIST','商品 %s 已经在<a href="'.tep_href_link(FILENAME_WISHLIST).'">我的收藏</a>列中 !');
define('TEXT_WISHLIST_NOTE', '提醒: 您的收藏列表尚未保存.登录或注册后将悠久保存');
define('TEXT_WISHLIST_EMPTY', '您尚未登录或未收藏任何商品!');
define('TEXT_ESTIMATE_SHIPPING','运费估算');
define('TEXT_ESTIMATE','估算');
define('TEXT_COMPARE','对比');
define('TEXT_OR','或');
define('TEXT_REMOVE','删除');
define('FREE_GIFT_CHOICE', '您可免费选择 %s 件赠品');
...
define('FOOTER_TEXT_BODY', '版权所有 &copy; ' . date('Y') . ' <a href="' . tep_href_link(FILENAME_DEFAULT) . '">' . STORE_NAME . '</a><br />版本由<a href="http://www.oscommerce.com.cn" target="_blank">www.osCommerce.com.cn</a>汉化');
?>